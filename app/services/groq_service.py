...
class GroqService:
    ...
    def get_customer_context(self, customer_email=None, order_number=None):
        ...
        return context
    def chat(self, user_message, customer_email=None, order_number=None):
        try:
            db_context = self.get_customer_context(customer_email, order_number)
...
- Returns and refunds
- General questions
Be friendly, concise, and professional. If you have customer or order information, use it to provide personalized assistance.
"""
            if db_context:
